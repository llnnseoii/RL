 ...
 *
 * NumberCrunching_50000_types.h
 *
 * Code generation for function 'NumberCrunching_50000'
 *
 */

#ifndef __NUMBERCRUNCHING_50000_TYPES_H__
#define __NUMBERCRUNCHING_50000_TYPES_H__
...
typedef struct {
  real_T Polyps[2550000];
  real_T PolypYear[2550000];
  real_T PolypLocation[2550000];
  real_T AdvProgression[2550000];
  real_T EarlyProgression[2550000];
} b_struct_T;
...
typedef struct {
  ...
  real_T TimeStage_I[1250000];
  real_T TimeStage_II[1250000];
  real_T TimeStage_III[1250000];
  real_T SympTime[1250000];
  real_T SympStage[1250000];
  real_T DwellTime[1250000];
} c_struct_T;
...
typedef struct {
  real_T Colonoscopy[50000];
  real_T Polyp[50000];
  real_T AdvPolyp[50000];
  real_T Cancer[50000];
  real_T ScreenTest[50000];
  real_T Included[50000];
  real_T TestDone[50000];
  real_T TestYear[50000];
  real_T TestYear2[50000];
} struct8_T;
...
typedef struct {
  real_T Stage[500000];
  real_T Location[500000];
  real_T Sojourn[500000];
  real_T DwellTime[500000];
  real_T Gender[500000];
  real_T Detection[500000];
  real_T PatientNumber[500000];
} struct9_T;

#endif                                 /*typedef_struct9_T*/

#ifndef typedef_NumberCrunching_50000StackData
#define typedef_NumberCrunching_50000StackData
...
} NumberCrunching_50000StackData;

#endif                                 /*typedef_NumberCrunching_50000StackData*/
...
/* End of code generation (NumberCrunching_50000_types.h) */
