 ...
 *
 * NumberCrunching_10000_types.h
 *
 * Code generation for function 'NumberCrunching_10000'
 *
 */

#ifndef __NUMBERCRUNCHING_10000_TYPES_H__
#define __NUMBERCRUNCHING_10000_TYPES_H__
...
typedef struct {
  real_T Polyps[510000];
  real_T PolypYear[510000];
  real_T PolypLocation[510000];
  real_T AdvProgression[510000];
  real_T EarlyProgression[510000];
} b_struct_T;
...
typedef struct {
  real_T Cancer[250000];
  real_T CancerYear[250000];
  real_T CancerLocation[250000];
  real_T TimeStage_I[250000];
  real_T TimeStage_II[250000];
  real_T TimeStage_III[250000];
  real_T SympTime[250000];
  real_T SympStage[250000];
  real_T DwellTime[250000];
} c_struct_T;
...
typedef struct {
  real_T Cancer[500000];
  real_T CancerYear[500000];
  real_T CancerLocation[500000];
  real_T MortTime[500000];
} struct_T;
...
typedef struct {
  real_T Colonoscopy[10000];
  real_T Polyp[10000];
  real_T AdvPolyp[10000];
  real_T Cancer[10000];
  real_T ScreenTest[10000];
  real_T Included[10000];
  real_T TestDone[10000];
  real_T TestYear[10000];
  real_T TestYear2[10000];
} struct8_T;
...
typedef struct {
  real_T Stage[100000];
  real_T Location[100000];
  real_T Sojourn[100000];
  real_T DwellTime[100000];
  real_T Gender[100000];
  real_T Detection[100000];
  real_T PatientNumber[100000];
} struct9_T;

#endif                                 /*typedef_struct9_T*/

#ifndef typedef_NumberCrunching_10000StackData
#define typedef_NumberCrunching_10000StackData
...
} NumberCrunching_10000StackData;

#endif                                 /*typedef_NumberCrunching_10000StackData*/
...
/* End of code generation (NumberCrunching_10000_types.h) */
