...
MAKEFILE = NumberCrunching_10000_mex.mk

include NumberCrunching_10000_mex.mki


SRC_FILES =  \
	NumberCrunching_10000_mexutil.c \
	NumberCrunching_10000_data.c \
	NumberCrunching_10000_initialize.c \
	NumberCrunching_10000_terminate.c \
	...
	NumberCrunching_10000_emxutil.c

MEX_FILE_NAME_WO_EXT = NumberCrunching_10000_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\NumberCrunching_10000"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NumberCrunching_10000/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
