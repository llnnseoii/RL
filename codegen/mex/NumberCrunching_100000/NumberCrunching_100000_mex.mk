...
MAKEFILE = NumberCrunching_100000_mex.mk

include NumberCrunching_100000_mex.mki


SRC_FILES =  \
	NumberCrunching_100000_mexutil.c \
	NumberCrunching_100000_data.c \
	NumberCrunching_100000_initialize.c \
	NumberCrunching_100000_terminate.c \
	...
	NumberCrunching_100000_emxutil.c

MEX_FILE_NAME_WO_EXT = NumberCrunching_100000_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\NumberCrunching_100000"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NumberCrunching_100000/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
