 ...
 *
 * _coder_NumberCrunching_100000_api.c
 *
 * Code generation for function '_coder_NumberCrunching_100000_api'
 *
 */
...
static real_T (*bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *ScreeningPreference, const char_T *identifier))[100000];
...
static void e_emlrt_marshallOut(const real_T u[100000], const mxArray *y);
...
static const mxArray *f_emlrt_marshallOut(const real_T u[100000]);
...
static const mxArray *k_emlrt_marshallOut(const real_T u[1000000]);
...
static const mxArray *l_emlrt_marshallOut(const real_T u[10000000]);
...
static struct5_T q_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
  const emlrtMsgIdentifier *parentId);
static const mxArray *q_emlrt_marshallOut(const boolean_T u[10000000]);
...
static void e_emlrt_marshallOut(const real_T u[100000], const mxArray *y)
{
  static const int32_T iv1[2] = { 1, 100000 };
...
static const mxArray *f_emlrt_marshallOut(const real_T u[100000])
{
  ...
  const mxArray *m4;
  static const int32_T iv3[2] = { 1, 100000 };
...
static const mxArray *g_emlrt_marshallOut(const struct8_T *u)
{
  const mxArray *y;
  const mxArray *b_y;
  static const int32_T iv4[2] = { 1, 100000 };

  const mxArray *m5;
  real_T *pData;
  int32_T i;
  const mxArray *c_y;
  static const int32_T iv5[2] = { 1, 100000 };

  const mxArray *d_y;
  static const int32_T iv6[2] = { 1, 100000 };

  const mxArray *e_y;
  static const int32_T iv7[2] = { 1, 100000 };

  const mxArray *f_y;
  static const int32_T iv8[2] = { 1, 100000 };

  const mxArray *g_y;
  static const int32_T iv9[2] = { 1, 100000 };

  const mxArray *h_y;
  static const int32_T iv10[2] = { 1, 100000 };

  const mxArray *i_y;
  static const int32_T iv11[2] = { 1, 100000 };

  const mxArray *j_y;
  static const int32_T iv12[2] = { 1, 100000 };
...
static const mxArray *j_emlrt_marshallOut(const struct9_T *u)
{
  const mxArray *y;
  const mxArray *b_y;
  static const int32_T iv17[2] = { 100, 10000 };

  const mxArray *m8;
  real_T *pData;
  int32_T i;
  const mxArray *c_y;
  static const int32_T iv18[2] = { 100, 10000 };

  const mxArray *d_y;
  static const int32_T iv19[2] = { 100, 10000 };

  const mxArray *e_y;
  static const int32_T iv20[2] = { 100, 10000 };

  const mxArray *f_y;
  static const int32_T iv21[2] = { 100, 10000 };

  const mxArray *g_y;
  static const int32_T iv22[2] = { 100, 10000 };

  const mxArray *h_y;
  static const int32_T iv23[2] = { 100, 10000 };
...
static const mxArray *k_emlrt_marshallOut(const real_T u[1000000])
{
  ...
  const mxArray *m9;
  static const int32_T iv25[2] = { 100, 10000 };
...
static const mxArray *l_emlrt_marshallOut(const real_T u[10000000])
{
  ...
  const mxArray *m10;
  static const int32_T iv27[2] = { 100, 100000 };
...
static const mxArray *q_emlrt_marshallOut(const boolean_T u[10000000])
{
  ...
  const mxArray *m15;
  static const int32_T iv67[2] = { 100, 100000 };
...
void NumberCrunching_100000_api(NumberCrunching_100000StackData *SD, const
  mxArray *prhs[26], const mxArray *plhs[29])
{
  real_T (*DeathCause)[100000];
  real_T (*DeathYear)[100000];
  real_T (*NaturalDeathYear)[100000];
  ...
  real_T (*DwellTimeProgression)[1000000];
  real_T (*DwellTimeFastCancer)[1000000];
  real_T (*HasCancer)[10000000];
  real_T (*NumPolyps)[10000000];
  real_T (*MaxPolyps)[10000000];
  real_T (*AllPolyps)[600];
  real_T (*NumCancer)[10000000];
  real_T (*MaxCancer)[10000000];
  real_T (*EarlyPolypsRemoved)[100];
  real_T (*DiagnosedCancer)[10000000];
  real_T (*AdvancedPolypsRemoved)[100];
  boolean_T (*YearIncluded)[10000000];
  boolean_T (*YearAlive)[10000000];
  real_T p;
  ...
  DeathCause = (real_T (*)[100000])mxMalloc(sizeof(real_T [100000]));
  DeathYear = (real_T (*)[100000])mxMalloc(sizeof(real_T [100000]));
  NaturalDeathYear = (real_T (*)[100000])mxMalloc(sizeof(real_T [100000]));
  ...
  DwellTimeProgression = (real_T (*)[1000000])mxMalloc(sizeof(real_T [1000000]));
  DwellTimeFastCancer = (real_T (*)[1000000])mxMalloc(sizeof(real_T [1000000]));
  HasCancer = (real_T (*)[10000000])mxMalloc(sizeof(real_T [10000000]));
  NumPolyps = (real_T (*)[10000000])mxMalloc(sizeof(real_T [10000000]));
  MaxPolyps = (real_T (*)[10000000])mxMalloc(sizeof(real_T [10000000]));
  AllPolyps = (real_T (*)[600])mxMalloc(sizeof(real_T [600]));
  NumCancer = (real_T (*)[10000000])mxMalloc(sizeof(real_T [10000000]));
  MaxCancer = (real_T (*)[10000000])mxMalloc(sizeof(real_T [10000000]));
  EarlyPolypsRemoved = (real_T (*)[100])mxMalloc(sizeof(real_T [100]));
  DiagnosedCancer = (real_T (*)[10000000])mxMalloc(sizeof(real_T [10000000]));
  AdvancedPolypsRemoved = (real_T (*)[100])mxMalloc(sizeof(real_T [100]));
  YearIncluded = (boolean_T (*)[10000000])mxMalloc(sizeof(boolean_T [10000000]));
  YearAlive = (boolean_T (*)[10000000])mxMalloc(sizeof(boolean_T [10000000]));
  ...
  NumberCrunching_100000(SD, &st, p, &StageVariables, &Location, &Cost,
    &CostStage, &risc, &flag, SpecialText, &female, *Sensitivity, *ScreeningTest,
    *ScreeningPreference, *AgeProgression, *NewPolyp, *ColonoscopyLikelyhood,
    *IndividualRisk, &RiskDistribution, *Gender, *LifeTable, *MortalityMatrix,
    *LocationMatrix, *StageDuration, *tx1, *DirectCancerRate, DirectCancerSpeed,
    DwellSpeed, &y, *DeathCause, &SD->f3.Last, *DeathYear, *NaturalDeathYear,
    *DirectCancer, *DirectCancerR, *DirectCancer2, *DirectCancer2R,
    *ProgressedCancer, *ProgressedCancerR, &SD->f3.TumorRecord,
    *DwellTimeProgression, *DwellTimeFastCancer, *HasCancer, *NumPolyps,
    *MaxPolyps, *AllPolyps, *NumCancer, *MaxCancer, &SD->f3.PaymentType, &Money,
    &Number, *EarlyPolypsRemoved, *DiagnosedCancer, *AdvancedPolypsRemoved,
...
/* End of code generation (_coder_NumberCrunching_100000_api.c) */
