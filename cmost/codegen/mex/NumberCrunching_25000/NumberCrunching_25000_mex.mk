START_DIR = U:\CMOST\CZGKVV~9

MATLAB_ROOT = C:\PROGRA~1\MATLAB\R2015B~1
MAKEFILE = NumberCrunching_25000_mex.mk

include NumberCrunching_25000_mex.mki


SRC_FILES =  \
	NumberCrunching_25000_mexutil.c \
	NumberCrunching_25000_data.c \
	NumberCrunching_25000_initialize.c \
	NumberCrunching_25000_terminate.c \
	...
	NumberCrunching_25000_emxutil.c

MEX_FILE_NAME_WO_EXT = NumberCrunching_25000_mex
...
SYS_INCLUDE += -I"$(START_DIR)\codegen\mex\NumberCrunching_25000"
...
%.$(OBJEXT) : $(START_DIR)\codegen\mex\NumberCrunching_25000/%.c
	$(CC) -Fo"$@" $(CFLAGS) "$<"
