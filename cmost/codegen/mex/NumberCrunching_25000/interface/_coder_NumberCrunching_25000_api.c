 ...
 *
 * _coder_NumberCrunching_25000_api.c
 *
 * Code generation for function '_coder_NumberCrunching_25000_api'
 *
 */
...
static real_T (*bb_emlrt_marshallIn(const emlrtStack *sp, const mxArray
  *ScreeningPreference, const char_T *identifier))[25000];
...
static real_T (*cb_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
  const emlrtMsgIdentifier *parentId))[25000];
...
static void e_emlrt_marshallOut(const real_T u[25000], const mxArray *y);
...
static const mxArray *f_emlrt_marshallOut(const real_T u[25000]);
...
static real_T (*hc_emlrt_marshallIn(const emlrtStack *sp, const mxArray *src,
  const emlrtMsgIdentifier *msgId))[25000];
...
static const mxArray *k_emlrt_marshallOut(const real_T u[250000]);
...
static const mxArray *l_emlrt_marshallOut(const real_T u[2500000]);
...
static struct5_T q_emlrt_marshallIn(const emlrtStack *sp, const mxArray *u,
  const emlrtMsgIdentifier *parentId);
static const mxArray *q_emlrt_marshallOut(const boolean_T u[2500000]);
...
static void e_emlrt_marshallOut(const real_T u[25000], const mxArray *y)
{
  static const int32_T iv1[2] = { 1, 25000 };
...
static const mxArray *f_emlrt_marshallOut(const real_T u[25000])
{
  ...
  const mxArray *m4;
  static const int32_T iv3[2] = { 1, 25000 };
...
static const mxArray *g_emlrt_marshallOut(const struct8_T *u)
{
  const mxArray *y;
  const mxArray *b_y;
  static const int32_T iv4[2] = { 1, 25000 };

  const mxArray *m5;
  real_T *pData;
  int32_T i;
  const mxArray *c_y;
  static const int32_T iv5[2] = { 1, 25000 };

  const mxArray *d_y;
  static const int32_T iv6[2] = { 1, 25000 };

  const mxArray *e_y;
  static const int32_T iv7[2] = { 1, 25000 };

  const mxArray *f_y;
  static const int32_T iv8[2] = { 1, 25000 };

  const mxArray *g_y;
  static const int32_T iv9[2] = { 1, 25000 };

  const mxArray *h_y;
  static const int32_T iv10[2] = { 1, 25000 };

  const mxArray *i_y;
  static const int32_T iv11[2] = { 1, 25000 };

  const mxArray *j_y;
  static const int32_T iv12[2] = { 1, 25000 };
...
{
  real_T (*ret)[25000];
  static const int32_T dims[2] = { 1, 25000 };

  emlrtCheckBuiltInR2012b(sp, msgId, src, "double", false, 2U, dims);
  ret = (real_T (*)[25000])mxGetData(src);
  emlrtDestroyArray(&src);
  return ret;
}
...
static const mxArray *j_emlrt_marshallOut(const struct9_T *u)
{
  const mxArray *y;
  const mxArray *b_y;
  static const int32_T iv17[2] = { 100, 2500 };

  const mxArray *m8;
  real_T *pData;
  int32_T i;
  const mxArray *c_y;
  static const int32_T iv18[2] = { 100, 2500 };

  const mxArray *d_y;
  static const int32_T iv19[2] = { 100, 2500 };

  const mxArray *e_y;
  static const int32_T iv20[2] = { 100, 2500 };

  const mxArray *f_y;
  static const int32_T iv21[2] = { 100, 2500 };

  const mxArray *g_y;
  static const int32_T iv22[2] = { 100, 2500 };

  const mxArray *h_y;
  static const int32_T iv23[2] = { 100, 2500 };
...
static const mxArray *k_emlrt_marshallOut(const real_T u[250000])
{
  ...
  const mxArray *m9;
  static const int32_T iv25[2] = { 100, 2500 };
...
static const mxArray *l_emlrt_marshallOut(const real_T u[2500000])
{
  ...
  const mxArray *m10;
  static const int32_T iv27[2] = { 100, 25000 };
...
static const mxArray *q_emlrt_marshallOut(const boolean_T u[2500000])
{
  ...
  const mxArray *m15;
  static const int32_T iv67[2] = { 100, 25000 };
...
void NumberCrunching_25000_api(NumberCrunching_25000StackData *SD, const mxArray
  *prhs[26], const mxArray *plhs[29])
{
  real_T (*DeathCause)[25000];
  real_T (*DeathYear)[25000];
  real_T (*NaturalDeathYear)[25000];
  ...
  real_T (*DwellTimeProgression)[250000];
  real_T (*DwellTimeFastCancer)[250000];
  real_T (*HasCancer)[2500000];
  real_T (*NumPolyps)[2500000];
  real_T (*MaxPolyps)[2500000];
  real_T (*AllPolyps)[600];
  real_T (*NumCancer)[2500000];
  real_T (*MaxCancer)[2500000];
  real_T (*EarlyPolypsRemoved)[100];
  real_T (*DiagnosedCancer)[2500000];
  real_T (*AdvancedPolypsRemoved)[100];
  boolean_T (*YearIncluded)[2500000];
  boolean_T (*YearAlive)[2500000];
  real_T p;
  ...
  real_T (*ScreeningPreference)[25000];
  real_T (*AgeProgression)[900];
  real_T (*NewPolyp)[150];
  real_T (*ColonoscopyLikelyhood)[150];
  real_T (*IndividualRisk)[25000];
  ...
  DeathCause = (real_T (*)[25000])mxMalloc(sizeof(real_T [25000]));
  DeathYear = (real_T (*)[25000])mxMalloc(sizeof(real_T [25000]));
  NaturalDeathYear = (real_T (*)[25000])mxMalloc(sizeof(real_T [25000]));
  ...
  DwellTimeProgression = (real_T (*)[250000])mxMalloc(sizeof(real_T [250000]));
  DwellTimeFastCancer = (real_T (*)[250000])mxMalloc(sizeof(real_T [250000]));
  HasCancer = (real_T (*)[2500000])mxMalloc(sizeof(real_T [2500000]));
  NumPolyps = (real_T (*)[2500000])mxMalloc(sizeof(real_T [2500000]));
  MaxPolyps = (real_T (*)[2500000])mxMalloc(sizeof(real_T [2500000]));
  AllPolyps = (real_T (*)[600])mxMalloc(sizeof(real_T [600]));
  NumCancer = (real_T (*)[2500000])mxMalloc(sizeof(real_T [2500000]));
  MaxCancer = (real_T (*)[2500000])mxMalloc(sizeof(real_T [2500000]));
  EarlyPolypsRemoved = (real_T (*)[100])mxMalloc(sizeof(real_T [100]));
  DiagnosedCancer = (real_T (*)[2500000])mxMalloc(sizeof(real_T [2500000]));
  AdvancedPolypsRemoved = (real_T (*)[100])mxMalloc(sizeof(real_T [100]));
  YearIncluded = (boolean_T (*)[2500000])mxMalloc(sizeof(boolean_T [2500000]));
  YearAlive = (boolean_T (*)[2500000])mxMalloc(sizeof(boolean_T [2500000]));
  ...
  NumberCrunching_25000(SD, &st, p, &StageVariables, &Location, &Cost,
...
/* End of code generation (_coder_NumberCrunching_25000_api.c) */
