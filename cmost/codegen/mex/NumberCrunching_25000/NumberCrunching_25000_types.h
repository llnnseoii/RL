 ...
 *
 * NumberCrunching_25000_types.h
 *
 * Code generation for function 'NumberCrunching_25000'
 *
 */

#ifndef __NUMBERCRUNCHING_25000_TYPES_H__
#define __NUMBERCRUNCHING_25000_TYPES_H__
...
typedef struct {
  real_T Polyps[1275000];
  real_T PolypYear[1275000];
  real_T PolypLocation[1275000];
  real_T AdvProgression[1275000];
  real_T EarlyProgression[1275000];
} b_struct_T;
...
typedef struct {
  real_T Cancer[625000];
  real_T CancerYear[625000];
  real_T CancerLocation[625000];
  real_T TimeStage_I[625000];
  real_T TimeStage_II[625000];
  real_T TimeStage_III[625000];
  real_T SympTime[625000];
  real_T SympStage[625000];
  real_T DwellTime[625000];
} c_struct_T;
...
typedef struct {
  real_T Cancer[1250000];
  real_T CancerYear[1250000];
  real_T CancerLocation[1250000];
  real_T MortTime[1250000];
} struct_T;
...
typedef struct {
  real_T Colonoscopy[25000];
  real_T Polyp[25000];
  real_T AdvPolyp[25000];
  real_T Cancer[25000];
  real_T ScreenTest[25000];
  real_T Included[25000];
  real_T TestDone[25000];
  real_T TestYear[25000];
  real_T TestYear2[25000];
} struct8_T;
...
typedef struct {
  real_T Stage[250000];
  real_T Location[250000];
  real_T Sojourn[250000];
  real_T DwellTime[250000];
  real_T Gender[250000];
  real_T Detection[250000];
  real_T PatientNumber[250000];
} struct9_T;

#endif                                 /*typedef_struct9_T*/

#ifndef typedef_NumberCrunching_25000StackData
#define typedef_NumberCrunching_25000StackData
...
} NumberCrunching_25000StackData;

#endif                                 /*typedef_NumberCrunching_25000StackData*/
...
/* End of code generation (NumberCrunching_25000_types.h) */
