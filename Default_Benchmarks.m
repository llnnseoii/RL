...
% Early Polyp= 초기 용종 관련 실제 통계. (25세 중 4.5%가 초기 용종이어야 한다 등등.)
...
% P1, P2, P3, P4, P5, P6, Ca1, Ca2, Ca3, Ca4 =screening sensitivity-> action의 결곽 결정(screening시 용종 또는 특정 병기의 암 발견 확률)
